...
public  class ValueType : global::haxe.lang.Enum {
	static ValueType() {
		#line 50 "/var/dev/main/haxe/std/cs/_std/Type.hx"
		...
		#line 59 "/var/dev/main/haxe/std/cs/_std/Type.hx"
	...
	public static   global::ValueType TClass(global::System.Type c){
		unchecked {
			#line 57 "/var/dev/main/haxe/std/cs/_std/Type.hx"
	...
	public static   global::ValueType TEnum(global::System.Type e){
		unchecked {
			#line 58 "/var/dev/main/haxe/std/cs/_std/Type.hx"
...
public  class Type : global::haxe.lang.HxObject {
	public    Type(global::haxe.lang.EmptyObject empty){
		unchecked {
			#line 62 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			{
			}
	...
	public static   global::System.Type getSuperClass(global::System.Type c){
		unchecked {
			#line 87 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			...
			if (( ( global::haxe.lang.Runtime.typeEq(@base, default(global::System.Type)) || string.Equals(global::haxe.lang.Runtime.concat(global::Std.@string(@base), ""), "haxe.lang.HxObject") ) || string.Equals(global::haxe.lang.Runtime.concat(global::Std.@string(@base), ""), "System.Object") )) {
				#line 91 "/var/dev/main/haxe/std/cs/_std/Type.hx"
				return default(global::System.Type);
			}
			
			#line 94 "/var/dev/main/haxe/std/cs/_std/Type.hx"
	...
	public static   string getClassName(global::System.Type c){
		unchecked {
			#line 98 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			string ret = global::haxe.lang.Runtime.toString(((global::System.Type) (c) ));
			#line 104 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			switch (ret){
				case "System.Int32":
				{
					#line 106 "/var/dev/main/haxe/std/cs/_std/Type.hx"
					return "Int";
				}
				...
				case "System.Double":
				{
					#line 107 "/var/dev/main/haxe/std/cs/_std/Type.hx"
					return "Float";
				}
				...
				case "System.String":
				{
					#line 108 "/var/dev/main/haxe/std/cs/_std/Type.hx"
					return "String";
				}
				...
				case "System.Object":
				{
					#line 109 "/var/dev/main/haxe/std/cs/_std/Type.hx"
					return "Dynamic";
				}
				...
				case "System.Type":
				{
					#line 110 "/var/dev/main/haxe/std/cs/_std/Type.hx"
					return "Class";
				}
				...
				default:
				{
					#line 111 "/var/dev/main/haxe/std/cs/_std/Type.hx"
	...
	public static   string getEnumName(global::System.Type e){
		unchecked {
			#line 117 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			string ret = global::haxe.lang.Runtime.toString(((global::System.Type) (e) ));
			#line 122 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			if (( ( ret.Length == 14 ) && string.Equals(ret, "System.Boolean") )) {
				#line 123 "/var/dev/main/haxe/std/cs/_std/Type.hx"
				return "Bool";
			}
			
			#line 124 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			return ret;
		}
		#line default
	}
	...
	public static   global::System.Type resolveClass(string name){
		unchecked {
			#line 133 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			global::System.Type t = global::System.Type.GetType(((string) (name) ));
			#line 135 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			if (global::haxe.lang.Runtime.typeEq(t, default(global::System.Type))) {
				#line 137 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			...
			#line 147 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			if (global::haxe.lang.Runtime.typeEq(t, default(global::System.Type))) {
				#line 149 "/var/dev/main/haxe/std/cs/_std/Type.hx"
				switch (name){
					case "Int":
					{
						#line 151 "/var/dev/main/haxe/std/cs/_std/Type.hx"
					...
					case "Float":
					{
						#line 152 "/var/dev/main/haxe/std/cs/_std/Type.hx"
					...
					case "Class":
					{
						#line 153 "/var/dev/main/haxe/std/cs/_std/Type.hx"
					...
					case "Dynamic":
					{
						#line 154 "/var/dev/main/haxe/std/cs/_std/Type.hx"
					...
					case "String":
					{
						#line 155 "/var/dev/main/haxe/std/cs/_std/Type.hx"
					...
					default:
					{
						#line 156 "/var/dev/main/haxe/std/cs/_std/Type.hx"
						return default(global::System.Type);
					}
				...
				if (( t.IsInterface && (((global::System.Type) (typeof(global::haxe.lang.IGenericObject)) )).IsAssignableFrom(((global::System.Type) (t) )) )) {
					...
					#line 169 "/var/dev/main/haxe/std/cs/_std/Type.hx"
					return ((global::System.Type) (t) );
				}
				 else {
					#line 171 "/var/dev/main/haxe/std/cs/_std/Type.hx"
					return ((global::System.Type) (t) );
				}
	...
	public static   T createInstance<T>(global::System.Type cl, global::Array args){
		unchecked {
			#line 190 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			if (global::haxe.lang.Runtime.refEq(cl, typeof(string))) {
				#line 191 "/var/dev/main/haxe/std/cs/_std/Type.hx"
				return global::haxe.lang.Runtime.genericCast<T>(args[0]);
			}
			
			#line 192 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			global::System.Type t = ((global::System.Type) (cl) );
			if (t.IsInterface) {
				#line 196 "/var/dev/main/haxe/std/cs/_std/Type.hx"
				global::System.Type cl1 = global::Type.resolveClass(global::Type.getClassName(cl));
				#line 196 "/var/dev/main/haxe/std/cs/_std/Type.hx"
				t = cl1;
			}
			
			#line 198 "/var/dev/main/haxe/std/cs/_std/Type.hx"
	...
	public static   T createEmptyInstance<T>(global::System.Type cl){
		unchecked {
			#line 204 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			global::System.Type t = ((global::System.Type) (cl) );
			if (t.IsInterface) {
				#line 208 "/var/dev/main/haxe/std/cs/_std/Type.hx"
				global::System.Type cl1 = global::Type.resolveClass(global::Type.getClassName(cl));
				#line 208 "/var/dev/main/haxe/std/cs/_std/Type.hx"
				t = cl1;
			}
			
			#line 211 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			if (global::Reflect.hasField(cl, "__hx_createEmpty")) {
				#line 212 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			...
			#line 213 "/var/dev/main/haxe/std/cs/_std/Type.hx"
	...
	public static   T createEnumIndex<T>(global::System.Type e, int index, global::Array @params){
		unchecked {
			#line 233 "/var/dev/main/haxe/std/cs/_std/Type.hx"
	...
	public static   global::Array<object> getEnumConstructs(global::System.Type e){
		unchecked {
			#line 285 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			if (global::Reflect.hasField(e, "constructs")) {
				#line 286 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			...
			#line 287 "/var/dev/main/haxe/std/cs/_std/Type.hx"
		...
		unchecked {
			...
			global::Array<T> ret = new global::Array<T>(new T[]{});
			{
				...
				while (( _g < ctors.length )){
					...
					#line 390 "/var/dev/main/haxe/std/cs/_std/Type.hx"
					 ++ _g;
					#line 392 "/var/dev/main/haxe/std/cs/_std/Type.hx"
					T v = global::haxe.lang.Runtime.genericCast<T>(global::Reflect.field(e, ctor));
					if (global::Std.@is(v, e)) {
						#line 394 "/var/dev/main/haxe/std/cs/_std/Type.hx"
						ret.push(v);
					}
			...
			#line 397 "/var/dev/main/haxe/std/cs/_std/Type.hx"
			return ret;
		}
		#line default
	}
