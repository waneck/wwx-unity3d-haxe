...
namespace haxe.lang{
	public  class HxObject : global::haxe.lang.IHxObject {
		public    HxObject(global::haxe.lang.EmptyObject empty){
			unchecked {
				#line 27 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				{
				}
...
namespace haxe.lang{
	public  class DynamicObject : global::haxe.lang.HxObject {
		...
		public    DynamicObject(){
			unchecked {
				#line 40 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
		...
		public static   void __hx_ctor_haxe_lang_DynamicObject(global::haxe.lang.DynamicObject __temp_me15){
			unchecked {
				#line 40 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				__temp_me15.__hx_hashes = new global::Array<int>(new int[]{});
				#line 40 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				__temp_me15.__hx_dynamics = new global::Array<object>(new object[]{});
				#line 40 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				__temp_me15.__hx_hashes_f = new global::Array<int>(new int[]{});
				#line 40 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				__temp_me15.__hx_dynamics_f = new global::Array<double>(new double[]{});
			}
			#line default
		}
		
		
		public static   void __hx_ctor_haxe_lang_DynamicObject(global::haxe.lang.DynamicObject __temp_me14, global::Array<int> __hx_hashes, global::Array<object> __hx_dynamics, global::Array<int> __hx_hashes_f, global::Array<double> __hx_dynamics_f){
			unchecked {
				#line 40 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
		...
		public virtual   string toString(){
			unchecked {
				#line 44 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				...
				if (( ts != default(global::haxe.lang.Function) )) {
					#line 46 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					return global::haxe.lang.Runtime.toString(ts.__hx_invoke0_o());
				}
				
				#line 47 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				global::StringBuf ret = new global::StringBuf();
				ret.b.Append(((object) ("{") ));
				bool first = true;
				{
					#line 50 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					int _g = 0;
					#line 50 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					...
					while (( _g < _g1.length )){
						...
						#line 50 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
						 ++ _g;
						#line 52 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
						if (first) {
							#line 53 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
							first = false;
						}
						 else {
							#line 55 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
							ret.b.Append(((object) (",") ));
						}
						
						#line 56 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
						ret.b.Append(((object) (" ") ));
						#line 56 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
						ret.b.Append(((object) (global::Std.@string(f)) ));
						ret.b.Append(((object) (" : ") ));
						{
							#line 58 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				...
				#line 60 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				if ( ! (first) ) {
					#line 60 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					ret.b.Append(((object) (" ") ));
				}
				
				#line 61 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				ret.b.Append(((object) ("}") ));
				return ret.toString();
			}
			#line default
		...
		public override   void __hx_getFields(global::Array<object> baseArr){
			unchecked {
				#line 40 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				{
					...
					{
						#line 40 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
						object __temp_iterator20 = this.__hx_hashes.iterator();
						#line 40 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
						while (global::haxe.lang.Runtime.toBool(global::haxe.lang.Runtime.callField(__temp_iterator20, "hasNext", 407283053, default(global::Array)))){
							#line 40 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
							int __temp_field17 = ((int) (global::haxe.lang.Runtime.toInt(global::haxe.lang.Runtime.callField(__temp_iterator20, "next", 1224901875, default(global::Array)))) );
							#line 40 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					...
					{
						#line 40 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
						object __temp_iterator21 = this.__hx_hashes_f.iterator();
						#line 40 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
						while (global::haxe.lang.Runtime.toBool(global::haxe.lang.Runtime.callField(__temp_iterator21, "hasNext", 407283053, default(global::Array)))){
							#line 40 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
							int __temp_field16 = ((int) (global::haxe.lang.Runtime.toInt(global::haxe.lang.Runtime.callField(__temp_iterator21, "next", 1224901875, default(global::Array)))) );
							#line 40 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
							baseArr.push(global::haxe.lang.FieldLookup.lookupHash(__temp_field16));
						}
...
namespace haxe.lang{
	public  class Enum : global::haxe.lang.HxObject {
		public    Enum(global::haxe.lang.EmptyObject empty){
			unchecked {
				#line 75 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				{
				}
		...
		public    Enum(int index, global::Array<object> @params){
			unchecked {
				#line 82 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				this.index = index;
				this.@params = @params;
			}
			#line default
		...
		public   string getTag(){
			unchecked {
				#line 87 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
		...
		public virtual   string toString(){
			unchecked {
				#line 92 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				if (( ( this.@params == default(global::Array<object>) ) || ( this.@params.length == 0 ) )) {
					#line 92 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					return this.getTag();
				}
				
				#line 93 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				global::StringBuf ret = new global::StringBuf();
				{
					#line 94 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				...
				bool first = true;
				{
					#line 96 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					int _g = 0;
					#line 96 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					...
					while (( _g < _g1.length )){
						...
						#line 96 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
						 ++ _g;
						#line 98 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
						if (first) {
							#line 99 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
							first = false;
						}
						 else {
							#line 101 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
							ret.b.Append(((object) (",") ));
						}
						
						#line 102 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
						ret.b.Append(((object) (global::Std.@string(p)) ));
					}
					
				}
				
				#line 104 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				ret.b.Append(((object) (")") ));
				return ret.toString();
			}
			#line default
		...
		public override   bool Equals(object obj){
			unchecked {
				#line 109 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				if (global::haxe.lang.Runtime.eq(obj, this)) {
					#line 110 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					return true;
				}
				
				#line 111 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				...
				if ( ! (ret) ) {
					#line 114 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					return false;
				}
				
				#line 115 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				if (( obj1.@params == this.@params )) {
					#line 116 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					return true;
				}
				
				#line 117 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				int len = 0;
				if (( ( ( obj1.@params == default(global::Array<object>) ) || ( this.@params == default(global::Array<object>) ) ) || ( (len = this.@params.length) != obj1.@params.length ) )) {
					#line 119 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					return false;
				}
				
				#line 120 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				{
					#line 120 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					int _g = 0;
					#line 120 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					while (( _g < ((int) (len) ) )){
						#line 120 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
						int i = _g++;
						#line 122 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
						if ( ! (global::Type.enumEq<object>(obj1.@params[i], this.@params[i])) ) {
							#line 123 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
							return false;
						}
				...
				#line 125 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				return true;
			}
			#line default
		}
		...
		public override   int GetHashCode(){
			unchecked {
				#line 130 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				int h = 19;
				if (( this.@params != default(global::Array<object>) )) {
					#line 131 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					int _g = 0;
					#line 131 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					global::Array<object> _g1 = this.@params;
					#line 131 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
					while (( _g < _g1.length )){
						...
						#line 131 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
						 ++ _g;
						#line 133 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
						h = ( h * 31 );
						if (( ! (global::haxe.lang.Runtime.refEq(p, default(object))) )) {
							#line 135 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
							h += p.GetHashCode();
						}
				...
				#line 137 "/var/dev/main/haxe/std/cs/internal/HxObject.hx"
				h += this.index;
				return h;
			}
			#line default
