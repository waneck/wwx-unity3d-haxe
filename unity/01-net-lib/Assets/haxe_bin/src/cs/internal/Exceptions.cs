...
namespace haxe.lang{
	public  class Exceptions {
		public    Exceptions(){
			unchecked {
				#line 25 "/var/dev/main/haxe/std/cs/internal/Exceptions.hx"
				{
				}
...
namespace haxe.lang{
	public  class HaxeException : global::System.Exception {
		public    HaxeException(object obj) : base(){
			unchecked {
				#line 41 "/var/dev/main/haxe/std/cs/internal/Exceptions.hx"
				if (( obj is global::haxe.lang.HaxeException )) {
					#line 43 "/var/dev/main/haxe/std/cs/internal/Exceptions.hx"
					global::haxe.lang.HaxeException _obj = ((global::haxe.lang.HaxeException) (obj) );
					obj = _obj.getObject();
				}
				
				#line 46 "/var/dev/main/haxe/std/cs/internal/Exceptions.hx"
				this.obj = obj;
			}
			#line default
		}
		...
		public static   global::System.Exception wrap(object obj){
			unchecked {
				#line 61 "/var/dev/main/haxe/std/cs/internal/Exceptions.hx"
				if (( obj is global::System.Exception )) {
					#line 61 "/var/dev/main/haxe/std/cs/internal/Exceptions.hx"
					return ((global::System.Exception) (obj) );
				}
				
				#line 63 "/var/dev/main/haxe/std/cs/internal/Exceptions.hx"
		...
		public virtual   object getObject(){
			unchecked {
				#line 51 "/var/dev/main/haxe/std/cs/internal/Exceptions.hx"
				return this.obj;
			}
			#line default
		}
		...
		public virtual   string toString(){
			unchecked {
				#line 56 "/var/dev/main/haxe/std/cs/internal/Exceptions.hx"
