...
public  class StringTools : global::haxe.lang.HxObject {
	public    StringTools(global::haxe.lang.EmptyObject empty){
		unchecked {
			#line 32 "/var/dev/main/haxe/std/StringTools.hx"
			{
			}
	...
	public static   string urlEncode(string s){
		unchecked {
			#line 52 "/var/dev/main/haxe/std/StringTools.hx"
	...
	public static   string urlDecode(string s){
		unchecked {
			#line 79 "/var/dev/main/haxe/std/StringTools.hx"
	...
	public static   string htmlUnescape(string s){
		unchecked {
			#line 121 "/var/dev/main/haxe/std/StringTools.hx"
	...
	public static   bool startsWith(string s, string start){
		unchecked {
			#line 135 "/var/dev/main/haxe/std/StringTools.hx"
	...
	public static   bool endsWith(string s, string end){
		unchecked {
			#line 152 "/var/dev/main/haxe/std/StringTools.hx"
	...
	public static   bool isSpace(string s, int pos){
		unchecked {
			#line 173 "/var/dev/main/haxe/std/StringTools.hx"
	...
	public static   string ltrim(string s){
		unchecked {
			#line 188 "/var/dev/main/haxe/std/StringTools.hx"
			return s.TrimStart();
		}
		#line default
	}
	...
	public static   string rtrim(string s){
		unchecked {
			#line 213 "/var/dev/main/haxe/std/StringTools.hx"
			return s.TrimEnd();
		}
		#line default
	}
	...
	public static   string trim(string s){
		unchecked {
			#line 235 "/var/dev/main/haxe/std/StringTools.hx"
			return s.Trim();
		}
		#line default
	}
	...
	public static   string lpad(string s, string c, int l){
		unchecked {
			#line 256 "/var/dev/main/haxe/std/StringTools.hx"
			if (( c.Length <= 0 )) {
				#line 257 "/var/dev/main/haxe/std/StringTools.hx"
				return s;
			}
			
			#line 259 "/var/dev/main/haxe/std/StringTools.hx"
			while (( s.Length < l )){
				#line 260 "/var/dev/main/haxe/std/StringTools.hx"
				s = global::haxe.lang.Runtime.concat(c, s);
			}
			
			#line 262 "/var/dev/main/haxe/std/StringTools.hx"
			return s;
		}
		#line default
	}
	...
	public static   string rpad(string s, string c, int l){
		unchecked {
			#line 278 "/var/dev/main/haxe/std/StringTools.hx"
			if (( c.Length <= 0 )) {
				#line 279 "/var/dev/main/haxe/std/StringTools.hx"
				return s;
			}
			
			#line 281 "/var/dev/main/haxe/std/StringTools.hx"
			while (( s.Length < l )){
				#line 282 "/var/dev/main/haxe/std/StringTools.hx"
				s = global::haxe.lang.Runtime.concat(s, c);
			}
			
			#line 284 "/var/dev/main/haxe/std/StringTools.hx"
			return s;
		}
		#line default
	}
	...
	public static   string replace(string s, string sub, string @by){
		unchecked {
			#line 305 "/var/dev/main/haxe/std/StringTools.hx"
			if (( sub.Length == 0 )) {
				#line 306 "/var/dev/main/haxe/std/StringTools.hx"
				return global::haxe.lang.StringExt.split(s, sub).@join(@by);
			}
			 else {
				#line 308 "/var/dev/main/haxe/std/StringTools.hx"
	...
	public static   string hex(int n, global::haxe.lang.Null<int> digits){
		unchecked {
			#line 326 "/var/dev/main/haxe/std/StringTools.hx"
			string s = "";
			string hexChars = "0123456789ABCDEF";
			do {
				#line 329 "/var/dev/main/haxe/std/StringTools.hx"
				s = global::haxe.lang.Runtime.concat(global::haxe.lang.StringExt.charAt(hexChars, ( n & 15 )), s);
				n = ((int) (( ((uint) (n) ) >> 4 )) );
			}
			while (( n > 0 ));
			#line 341 "/var/dev/main/haxe/std/StringTools.hx"
			if (digits.hasValue) {
				#line 342 "/var/dev/main/haxe/std/StringTools.hx"
				while (( s.Length < digits.@value )){
					#line 343 "/var/dev/main/haxe/std/StringTools.hx"
					s = global::haxe.lang.Runtime.concat("0", s);
				}
				
			}
			
			#line 345 "/var/dev/main/haxe/std/StringTools.hx"
			return s;
		}
		#line default
	}
	...
	public static   int fastCodeAt(string s, int index){
		unchecked {
			#line 374 "/var/dev/main/haxe/std/StringTools.hx"
	...
	public static   bool isEof(int c){
		unchecked {
			#line 397 "/var/dev/main/haxe/std/StringTools.hx"
			return ( c == -1 );
		}
		#line default
	}
