...
public sealed class Array<T> : global::haxe.lang.HxObject, global::Array {
	...
	public    Array(global::haxe.lang.EmptyObject empty){
		unchecked {
			#line 34 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			{
			}
	...
	public    Array(){
		unchecked {
			#line 56 "/var/dev/main/haxe/std/cs/_std/Array.hx"
	...
	public static   void __hx_ctor__Array<T_c>(global::Array<T_c> __temp_me4){
		unchecked {
			#line 58 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			__temp_me4.length = 0;
	...
	public   object Array_cast<T_c>(){
		unchecked {
			...
			{
				#line 34 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				object __temp_iterator18 = global::Reflect.fields(this).iterator();
				#line 34 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				while (global::haxe.lang.Runtime.toBool(global::haxe.lang.Runtime.callField(__temp_iterator18, "hasNext", 407283053, default(global::Array)))){
					#line 34 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					string field = global::haxe.lang.Runtime.toString(global::haxe.lang.Runtime.callField(__temp_iterator18, "next", 1224901875, default(global::Array)));
					#line 34 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					switch (field){
						case "__a":
						{
	...
	public   global::Array<T> concat(global::Array<T> a){
		unchecked {
			#line 64 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			...
			#line 69 "/var/dev/main/haxe/std/cs/_std/Array.hx"
	...
	public   void concatNative(T[] a){
		unchecked {
			...
			if (( ( __a as global::System.Array ).Length >= len )) {
				...
				#line 84 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				this.__a = newarr;
			}
			
			#line 87 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			this.length = len;
		}
		#line default
	}
	...
	public   int indexOf(T x, global::haxe.lang.Null<int> fromIndex){
		unchecked {
			#line 92 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			int len = this.length;
			#line 92 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			int i = default(int);
			#line 92 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			...
			#line 93 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( i < 0 )) {
				#line 95 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				i += len;
				if (( i < 0 )) {
					#line 96 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					i = 0;
				}
				
			}
			
			#line 98 "/var/dev/main/haxe/std/cs/_std/Array.hx"
	...
	public   int lastIndexOf(T x, global::haxe.lang.Null<int> fromIndex){
		unchecked {
			#line 103 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			int len = this.length;
			#line 103 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			int i = default(int);
			#line 103 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			...
			#line 104 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( i >= len )) {
				#line 106 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				i = ( len - 1 );
			}
			 else {
				#line 108 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				if (( i < 0 )) {
					#line 110 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					i += len;
					if (( i < 0 )) {
						#line 111 "/var/dev/main/haxe/std/cs/_std/Array.hx"
						return -1;
					}
			...
			#line 113 "/var/dev/main/haxe/std/cs/_std/Array.hx"
	...
	public   string @join(string sep){
		unchecked {
			#line 118 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			global::StringBuf buf = new global::StringBuf();
			int i = -1;
			#line 121 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			bool first = true;
			int length = this.length;
			while ((  ++ i < length )){
				#line 125 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				if (first) {
					#line 126 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					first = false;
				}
				 else {
					#line 128 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					buf.b.Append(((object) (global::Std.@string(sep)) ));
				}
				
				#line 129 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				buf.b.Append(((object) (global::Std.@string(this.__a[i])) ));
			}
			
			#line 132 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			return buf.toString();
		}
		#line default
	}
	...
	public   global::haxe.lang.Null<T> pop(){
		unchecked {
			#line 137 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			T[] __a = this.__a;
			int length = this.length;
			if (( length > 0 )) {
				#line 141 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				T val = __a[ -- length];
				__a[length] = default(T);
				this.length = length;
				#line 145 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				return new global::haxe.lang.Null<T>(val, true);
			}
			 else {
				#line 147 "/var/dev/main/haxe/std/cs/_std/Array.hx"
	...
	public   int push(T x){
		unchecked {
			#line 153 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( this.length >= ( this.__a as global::System.Array ).Length )) {
				#line 155 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				...
				#line 159 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				this.__a = newarr;
			}
			
			#line 162 "/var/dev/main/haxe/std/cs/_std/Array.hx"
	...
	public   void reverse(){
		unchecked {
			#line 168 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			int i = 0;
			int l = this.length;
			T[] a = this.__a;
			int half = ( l >> 1 );
			l -= 1;
			while (( i < half )){
				#line 175 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				T tmp = a[i];
				a[i] = a[( l - i )];
				a[( l - i )] = tmp;
				i += 1;
	...
	public   global::haxe.lang.Null<T> shift(){
		unchecked {
			#line 184 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			int l = this.length;
			if (( l == 0 )) {
				#line 186 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				return default(global::haxe.lang.Null<T>);
			}
			
			#line 188 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			T[] a = this.__a;
			T x = a[0];
			l -= 1;
			...
			a[l] = default(T);
			this.length = l;
			#line 195 "/var/dev/main/haxe/std/cs/_std/Array.hx"
	...
	public   global::Array<T> slice(int pos, global::haxe.lang.Null<int> end){
		unchecked {
			#line 200 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( pos < 0 )) {
				#line 201 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				pos = ( this.length + pos );
				if (( pos < 0 )) {
					#line 203 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					pos = 0;
				}
				
			}
			
			#line 205 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if ( ! (end.hasValue) ) {
				#line 206 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				end = new global::haxe.lang.Null<int>(this.length, true);
			}
			 else {
				#line 207 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				if (( end.@value < 0 )) {
					#line 208 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					end = new global::haxe.lang.Null<int>(( this.length + end.@value ), true);
				}
				
			}
			
			#line 209 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( end.@value > this.length )) {
				#line 210 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				end = new global::haxe.lang.Null<int>(this.length, true);
			}
			
			#line 211 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			int len = ( end.@value - pos );
			if (( len < 0 )) {
				#line 212 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				return new global::Array<T>();
			}
			
			#line 214 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			T[] newarr = new T[((int) (len) )];
			global::System.Array.Copy(((global::System.Array) (this.__a) ), ((int) (pos) ), ((global::System.Array) (newarr) ), ((int) (0) ), ((int) (len) ));
			#line 217 "/var/dev/main/haxe/std/cs/_std/Array.hx"
	...
	public   void sort(global::haxe.lang.Function f){
		unchecked {
			#line 222 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( this.length == 0 )) {
				#line 223 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				return ;
			}
			
			#line 224 "/var/dev/main/haxe/std/cs/_std/Array.hx"
	...
	public   void quicksort(int lo, int hi, global::haxe.lang.Function f){
		unchecked {
			#line 229 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			T[] buf = this.__a;
			int i = lo;
			#line 230 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			int j = hi;
			T p = buf[( ( i + j ) >> 1 )];
			while (( i <= j )){
				#line 234 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				while (( ((int) (f.__hx_invoke2_f(default(double), buf[i], default(double), p)) ) < 0 )){
					#line 234 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					i++;
				}
				
				#line 235 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				while (( ((int) (f.__hx_invoke2_f(default(double), buf[j], default(double), p)) ) > 0 )){
					#line 235 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					j--;
				}
				
				#line 236 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				if (( i <= j )) {
					#line 238 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					T t = buf[i];
					buf[i++] = buf[j];
					buf[j--] = t;
				}
			...
			#line 244 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( lo < j )) {
				#line 244 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				this.quicksort(lo, j, f);
			}
			
			#line 245 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( i < hi )) {
				#line 245 "/var/dev/main/haxe/std/cs/_std/Array.hx"
	...
	public   global::Array<T> splice(int pos, int len){
		unchecked {
			#line 250 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( len < 0 )) {
				#line 250 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				return new global::Array<T>();
			}
			
			#line 251 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( pos < 0 )) {
				#line 252 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				pos = ( this.length + pos );
				if (( pos < 0 )) {
					#line 253 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					pos = 0;
				}
				
			}
			
			#line 255 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( pos > this.length )) {
				#line 256 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				pos = 0;
				len = 0;
			}
			 else {
				#line 258 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				if (( ( pos + len ) > this.length )) {
					#line 259 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					len = ( this.length - pos );
					if (( len < 0 )) {
						#line 260 "/var/dev/main/haxe/std/cs/_std/Array.hx"
						len = 0;
					}
			...
			#line 262 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			T[] a = this.__a;
			#line 264 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			T[] ret = new T[((int) (len) )];
			...
			#line 268 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			int end = ( pos + len );
			global::System.Array.Copy(((global::System.Array) (a) ), ((int) (end) ), ((global::System.Array) (a) ), ((int) (pos) ), ((int) (( this.length - end )) ));
			this.length -= len;
			while ((  -- len >= 0 )){
				#line 272 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				a[( this.length + len )] = default(T);
			}
			
			#line 273 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			return ret1;
		}
		#line default
	}
	...
	public   void spliceVoid(int pos, int len){
		unchecked {
			#line 278 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( len < 0 )) {
				#line 278 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				return ;
			}
			
			#line 279 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( pos < 0 )) {
				#line 280 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				pos = ( this.length + pos );
				if (( pos < 0 )) {
					#line 281 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					pos = 0;
				}
				
			}
			
			#line 283 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( pos > this.length )) {
				#line 284 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				pos = 0;
				len = 0;
			}
			 else {
				#line 286 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				if (( ( pos + len ) > this.length )) {
					#line 287 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					len = ( this.length - pos );
					if (( len < 0 )) {
						#line 288 "/var/dev/main/haxe/std/cs/_std/Array.hx"
						len = 0;
					}
			...
			#line 290 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			T[] a = this.__a;
			#line 292 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			int end = ( pos + len );
			global::System.Array.Copy(((global::System.Array) (a) ), ((int) (end) ), ((global::System.Array) (a) ), ((int) (pos) ), ((int) (( this.length - end )) ));
			this.length -= len;
			while ((  -- len >= 0 )){
				#line 296 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				a[( this.length + len )] = default(T);
			}
	...
	public   string toString(){
		unchecked {
			#line 301 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			global::StringBuf ret = new global::StringBuf();
			T[] a = this.__a;
			ret.b.Append(((object) ("[") ));
			bool first = true;
			{
				#line 305 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				int _g1 = 0;
				#line 305 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				int _g = this.length;
				#line 305 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				while (( _g1 < _g )){
					#line 305 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					int i = _g1++;
					#line 307 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					if (first) {
						#line 308 "/var/dev/main/haxe/std/cs/_std/Array.hx"
						first = false;
					}
					 else {
						#line 310 "/var/dev/main/haxe/std/cs/_std/Array.hx"
						ret.b.Append(((object) (",") ));
					}
					
					#line 311 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					ret.b.Append(((object) (global::Std.@string(a[i])) ));
				}
				
			}
			
			#line 314 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			ret.b.Append(((object) ("]") ));
			return ret.toString();
		}
		#line default
	...
	public   void insert(int pos, T x){
		unchecked {
			#line 339 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			int l = this.length;
			if (( pos < 0 )) {
				#line 341 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				pos = ( l + pos );
				if (( pos < 0 )) {
					#line 342 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					pos = 0;
				}
				
			}
			
			#line 344 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( pos >= l )) {
				#line 345 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				this.push(x);
				return ;
			}
			 else {
				#line 347 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				if (( pos == 0 )) {
					#line 348 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					this.unshift(x);
					return ;
				}
			...
			#line 352 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( l >= ( this.__a as global::System.Array ).Length )) {
				#line 354 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				int newLen = ( (( this.length << 1 )) + 1 );
				T[] newarr = new T[((int) (newLen) )];
				...
				#line 360 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				this.__a = newarr;
				 ++ this.length;
			}
			 else {
				#line 363 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				T[] __a = this.__a;
	...
	public   bool @remove(T x){
		unchecked {
			#line 373 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			T[] __a = this.__a;
			int i = -1;
			int length = this.length;
			while ((  ++ i < length )){
				#line 378 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				if (global::haxe.lang.Runtime.eq(__a[i], x)) {
					#line 380 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					...
					#line 383 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					return true;
				}
				
			}
			
			#line 387 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			return false;
		}
		#line default
	}
	...
	public   global::Array<S> map<S>(global::haxe.lang.Function f){
		unchecked {
			#line 391 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			global::Array<S> ret = new global::Array<S>(new S[]{});
			{
				#line 392 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				int _g = 0;
				#line 392 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			...
			#line 394 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			return ret;
		}
		#line default
	}
	...
	public   global::Array<T> filter(global::haxe.lang.Function f){
		unchecked {
			#line 398 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			global::Array<T> ret = new global::Array<T>(new T[]{});
			{
				#line 399 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				int _g = 0;
				#line 399 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				global::Array<T> _g1 = this;
				#line 399 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				while (( _g < _g1.length )){
					...
					if (global::haxe.lang.Runtime.toBool(f.__hx_invoke1_o(default(double), elt))) {
						#line 401 "/var/dev/main/haxe/std/cs/_std/Array.hx"
						ret.push(elt);
					}
			...
			#line 402 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			return ret;
		}
		#line default
	}
	...
	public   global::Array<T> copy(){
		unchecked {
			#line 407 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			int len = this.length;
			T[] __a = this.__a;
			T[] newarr = new T[((int) (len) )];
	...
	public   object iterator(){
		unchecked {
			#line 416 "/var/dev/main/haxe/std/cs/_std/Array.hx"
	...
	public   T __get(int idx){
		unchecked {
			#line 421 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			T[] __a = this.__a;
			uint idx1 = ((uint) (idx) );
			if (( idx1 >= this.length )) {
				#line 424 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				return default(T);
			}
			
			#line 426 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			return __a[((int) (idx1) )];
		}
		#line default
	}
	...
	public   T __set(int idx, T v){
		unchecked {
			#line 431 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			uint idx1 = ((uint) (idx) );
			T[] __a = this.__a;
			if (( idx1 >= ( __a as global::System.Array ).Length )) {
				#line 435 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				uint len = ( idx1 + 1 );
				if (( idx1 == ( __a as global::System.Array ).Length )) {
					#line 437 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					len = ((uint) (( (( idx1 << 1 )) + 1 )) );
				}
				
				#line 438 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				T[] newArr = new T[((int) (len) )];
				( __a as global::System.Array ).CopyTo(((global::System.Array) (newArr) ), ((int) (0) ));
				this.__a = __a = newArr;
			}
			
			#line 443 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			if (( idx1 >= this.length )) {
				#line 444 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				this.length = ((int) (( idx1 + 1 )) );
			}
			
			#line 446 "/var/dev/main/haxe/std/cs/_std/Array.hx"
	...
	public   T __unsafe_get(int idx){
		unchecked {
			#line 451 "/var/dev/main/haxe/std/cs/_std/Array.hx"
			return this.__a[idx];
		}
		#line default
	}
	...
	public   T __unsafe_set(int idx, T val){
		unchecked {
			#line 456 "/var/dev/main/haxe/std/cs/_std/Array.hx"
...
namespace _Array{
	public sealed class ArrayIterator<T> : global::haxe.lang.HxObject, global::_Array.ArrayIterator {
		public    ArrayIterator(global::haxe.lang.EmptyObject empty){
			unchecked {
				#line 461 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				{
				}
		...
		public    ArrayIterator(global::Array<T> a){
			unchecked {
				#line 467 "/var/dev/main/haxe/std/cs/_std/Array.hx"
		...
		public static   void __hx_ctor__Array_ArrayIterator<T_c>(global::_Array.ArrayIterator<T_c> __temp_me5, global::Array<T_c> a){
			unchecked {
				#line 469 "/var/dev/main/haxe/std/cs/_std/Array.hx"
				__temp_me5.arr = a;
		...
		public   object _Array_ArrayIterator_cast<T_c>(){
			unchecked {
				...
				{
					#line 461 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					object __temp_iterator19 = global::Reflect.fields(this).iterator();
					#line 461 "/var/dev/main/haxe/std/cs/_std/Array.hx"
					while (global::haxe.lang.Runtime.toBool(global::haxe.lang.Runtime.callField(__temp_iterator19, "hasNext", 407283053, default(global::Array)))){
						#line 461 "/var/dev/main/haxe/std/cs/_std/Array.hx"
						string field = global::haxe.lang.Runtime.toString(global::haxe.lang.Runtime.callField(__temp_iterator19, "next", 1224901875, default(global::Array)));
						#line 461 "/var/dev/main/haxe/std/cs/_std/Array.hx"
						switch (field){
							default:
							{
		...
		public   bool hasNext(){
			unchecked {
				#line 474 "/var/dev/main/haxe/std/cs/_std/Array.hx"
		...
		public   T next(){
			unchecked {
				#line 475 "/var/dev/main/haxe/std/cs/_std/Array.hx"
