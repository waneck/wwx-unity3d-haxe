...
namespace sys.io{
	public  class File : global::haxe.lang.HxObject {
		...
		public static   void __hx_ctor_sys_io_File(global::sys.io.File __temp_me32){
			unchecked {
				#line 25 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\io\\File.hx"
				{
				}
		...
		public static   global::sys.io.FileInput read(string path, global::haxe.lang.Null<bool> binary){
			unchecked {
				...
				bool __temp_binary30 = ( ( ! (binary.hasValue) ) ? (global::haxe.lang.Runtime.toBool(true)) : (binary.@value) );
